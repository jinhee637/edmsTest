		  ...
		  <ul class="GnbUl" id="gnbS">
			  <li id="LeftNavi1_rootmenu_02" class="current"><a href="${pageContext.request.contextPath}/admin/ManageCategory.do" target="content"><img src="${pageContext.request.contextPath}/images/img/menu1_off.gif" alt="카테고리관리" border="0"/></a>
			  		<ul id="LeftNavi1_submenu_01">
						  <li id="LeftNavi1_submenu_01_01" class="on"><a href="#" id="LeftNavi1_hlnkSubmenu_01_01"><img src = "img/gnb-2depth01-01-on.gif" alt="문서등록"  border="0"/></a></li>
						  <li id="LeftNavi1_submenu_01_02"><a href="#" id="LeftNavi1_hlnkSubmenu_01_02"><img src = "/images/img/gnb-2depth01-02-off.gif" alt="문서검색"  border="0"/></a></li>
						  <li id="LeftNavi1_submenu_01_03"><a href="#" id="LeftNavi1_hlnkSubmenu_01_03"><img src = "/images/img/gnb-2depth01-03-off.gif" alt="내문서"  border="0"/></a></li>    
				    </ul>
...
//			'select_multiple_modifier' : false
	...
	.bind("select_node.jstree",function(e, data){
  	...
  	$('#img_goDocInt').click(function(){
  		console.log("catSeq = " + $('#catSeq').val());
  	  $('#dummyfrm').attr('action','/user/docInsert.do');
  	  $('#dummyfrm').submit();
  	});
  });
 function goDocInsert(catSeq){
